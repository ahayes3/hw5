...
public class DeathScreen implements Screen {
	...
	TextButton button;
	public DeathScreen(Homework5 game) {
		this.game = game;
	...
	public void render(float delta) {
		...
		batch.begin();
		game.font.draw(batch,"DEAD",camera.viewportWidth/2f - (camera.viewportWidth/3f/2f),camera.viewportHeight/2f,camera.viewportWidth/3f,Align.center,true);
		button.draw(batch,1);
		batch.end();
		camera.update();
	}
